...
export type StorageHash =
  StorageHashBase<'6ba1a6a568d68c43306c9b42db375805338b3fc435c13aa5d10a69c7e2e0df8c'>;
...
export namespace Models {
  export type public_User = {
    ...
    foods: public_Food[];
    readonly [RelationKeys]?: 'foods';
  };
  export type public_Food = {
    id: CodecTypes['pg/int4@1']['output'];
        ...
        readonly entries: {
          readonly table: {
            readonly food: {
              ...
              indexes: readonly [
                {
                  readonly name: 'food_userId_idx_a489d58a';
                  readonly prefix: 'food_userId_idx';
